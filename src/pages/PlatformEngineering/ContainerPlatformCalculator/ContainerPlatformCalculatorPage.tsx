...
export function ContainerPlatformCalculatorPage() {
  usePageTitle("Container Platform Calculator Suite");
  ...
  return (
    <ToolPageLayout
      ...
      description="Sizing and capacity planning tools for container platform workloads."
      breadcrumbs={[
        {
          label: "Platform Engineering Tools",
          path: routePaths.platformEngineering,
        },
        { label: "Container Platform Calculator Suite" },
      ]}
        ...
        activeTab === "Capacity Planning" ? (
          <div className="space-y-6">
            ...
            <section>
              ...
              <div className="grid gap-4 lg:grid-cols-2">
                <GeneratedOutput title="Container Platform YAML" value={capacityOutputs.yaml} onCopy={() => void copyText(capacityOutputs.yaml, "YAML")} />
          ...
          <div className="space-y-6">
            ...
            <section>
              ...
              <div className="grid gap-4 lg:grid-cols-2">
                <GeneratedOutput title="Container Platform YAML" value={pvcOutputs.yaml} onCopy={() => void copyText(pvcOutputs.yaml, "YAML")} />
          ...
          <div className="space-y-6">
            ...
            <section>
              ...
              <div className="grid gap-4 lg:grid-cols-2">
                <GeneratedOutput title="Container Platform YAML" value={hpaOutputs.yaml} onCopy={() => void copyText(hpaOutputs.yaml, "YAML")} />
          ...
          <div className="space-y-6">
            ...
            <section>
              ...
              <div className="grid gap-4 lg:grid-cols-2">
                <GeneratedOutput title="Container Platform YAML" value={podOutputs.yaml} onCopy={() => void copyText(podOutputs.yaml, "YAML")} />
          ...
          <div className="space-y-6">
            ...
            <section>
              ...
              <div className="grid gap-4 lg:grid-cols-2">
                ...
                <GeneratedOutput title="Container Platform YAML" value={generatedOutputs.yaml} onCopy={() => void copyText(generatedOutputs.yaml, "YAML")} />
              </div>
            </section>
          </div>
        ) : undefined
